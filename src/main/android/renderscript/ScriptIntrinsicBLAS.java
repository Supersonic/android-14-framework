...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    public void CGEMV(int TransA, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 63, TransA, 0, 0, 0, 0, M, N, 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), X.getID(this.mRS), beta.f367x, beta.f368y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGEMV(int TransA, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 71, TransA, 0, 0, 0, 0, M, N, 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), X.getID(this.mRS), beta.f358x, beta.f359y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGBMV(int TransA, int KL, int KU, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 64, TransA, 0, 0, 0, 0, M, N, 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), X.getID(this.mRS), beta.f367x, beta.f368y, Y.getID(this.mRS), incX, incY, KL, KU);
    }
    ...
    public void ZGBMV(int TransA, int KL, int KU, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 72, TransA, 0, 0, 0, 0, M, N, 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), X.getID(this.mRS), beta.f358x, beta.f359y, Y.getID(this.mRS), incX, incY, KL, KU);
    }
    ...
    public void CHEMV(int Uplo2, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 95, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), X.getID(this.mRS), beta.f367x, beta.f368y, Y.getID(this.mRS), incX, incY, 0, 0);
    }

    public void CHBMV(int Uplo2, int K, Float2 alpha, Allocation A, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        int N = validateSYR2(Element.F32_2(this.mRS), Uplo2, X, incX, Y, incY, A);
        if (K >= 0) {
            this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 96, 0, 0, 0, Uplo2, 0, 0, N, K, alpha.f367x, alpha.f368y, A.getID(this.mRS), X.getID(this.mRS), beta.f367x, beta.f368y, Y.getID(this.mRS), incX, incY, 0, 0);
            return;
        }
    ...
    public void CHPMV(int Uplo2, Float2 alpha, Allocation Ap, Allocation X, int incX, Float2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 97, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f367x, alpha.f368y, Ap.getID(this.mRS), X.getID(this.mRS), beta.f367x, beta.f368y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGERU(Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 98, 0, 0, 0, 0, 0, M, N, 0, alpha.f367x, alpha.f368y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGERC(Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 99, 0, 0, 0, 0, 0, M, N, 0, alpha.f367x, alpha.f368y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CHER2(int Uplo2, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F32_2(this.mRS), Uplo2, X, incX, Y, incY, A);
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 102, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f367x, alpha.f368y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void CHPR2(int Uplo2, Float2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F32_2(this.mRS), Uplo2, X, incX, Y, incY, Ap);
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 103, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f367x, alpha.f368y, X.getID(this.mRS), Y.getID(this.mRS), 0.0f, 0.0f, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHEMV(int Uplo2, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 104, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), X.getID(this.mRS), beta.f358x, beta.f359y, Y.getID(this.mRS), incX, incY, 0, 0);
    }

    public void ZHBMV(int Uplo2, int K, Double2 alpha, Allocation A, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        int N = validateSYR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, A);
        if (K >= 0) {
            this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 105, 0, 0, 0, Uplo2, 0, 0, N, K, alpha.f358x, alpha.f359y, A.getID(this.mRS), X.getID(this.mRS), beta.f358x, beta.f359y, Y.getID(this.mRS), incX, incY, 0, 0);
            return;
        }
        throw new RSRuntimeException("K must be 0 or greater for HBMV");
    }
    ...
    public void ZHPMV(int Uplo2, Double2 alpha, Allocation Ap, Allocation X, int incX, Double2 beta, Allocation Y, int incY) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 106, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f358x, alpha.f359y, Ap.getID(this.mRS), X.getID(this.mRS), beta.f358x, beta.f359y, Y.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGERU(Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 107, 0, 0, 0, 0, 0, M, N, 0, alpha.f358x, alpha.f359y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGERC(Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 108, 0, 0, 0, 0, 0, M, N, 0, alpha.f358x, alpha.f359y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHER2(int Uplo2, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, A);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 111, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f358x, alpha.f359y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void ZHPR2(int Uplo2, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, Ap);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 112, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.f358x, alpha.f359y, X.getID(this.mRS), Y.getID(this.mRS), 0.0d, 0.0d, Ap.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void CGEMM(int TransA, int TransB, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 125, TransA, TransB, 0, 0, 0, M, N, K, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), beta.f367x, beta.f368y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZGEMM(int TransA, int TransB, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 131, TransA, TransB, 0, 0, 0, M, N, K, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), beta.f358x, beta.f359y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYMM(int Side2, int Uplo2, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 126, 0, 0, Side2, Uplo2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), beta.f367x, beta.f368y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYMM(int Side2, int Uplo2, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 132, 0, 0, Side2, Uplo2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), beta.f358x, beta.f359y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYRK(int Uplo2, int Trans, Float2 alpha, Allocation A, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 127, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), K, alpha.f367x, alpha.f368y, A.getID(this.mRS), 0L, beta.f367x, beta.f368y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYRK(int Uplo2, int Trans, Double2 alpha, Allocation A, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 133, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), K, alpha.f358x, alpha.f359y, A.getID(this.mRS), 0L, beta.f358x, beta.f359y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CSYR2K(int Uplo2, int Trans, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 128, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), K, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), beta.f367x, beta.f368y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZSYR2K(int Uplo2, int Trans, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 134, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), K, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), beta.f358x, beta.f359y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CTRMM(int Side2, int Uplo2, int TransA, int Diag2, Float2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 129, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0L, 0, 0, 0, 0);
    }
    ...
    public void ZTRMM(int Side2, int Uplo2, int TransA, int Diag2, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 135, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0L, 0, 0, 0, 0);
    }
    ...
    public void CTRSM(int Side2, int Uplo2, int TransA, int Diag2, Float2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 130, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), 0.0f, 0.0f, 0L, 0, 0, 0, 0);
    }
    ...
    public void ZTRSM(int Side2, int Uplo2, int TransA, int Diag2, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 136, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), 0.0d, 0.0d, 0L, 0, 0, 0, 0);
    }
    ...
    public void CHEMM(int Side2, int Uplo2, Float2 alpha, Allocation A, Allocation B, Float2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 137, 0, 0, Side2, Uplo2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), beta.f367x, beta.f368y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHEMM(int Side2, int Uplo2, Double2 alpha, Allocation A, Allocation B, Double2 beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 140, 0, 0, Side2, Uplo2, 0, C.getType().getY(), C.getType().getX(), 0, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), beta.f358x, beta.f359y, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void CHER2K(int Uplo2, int Trans, Float2 alpha, Allocation A, Allocation B, float beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Complex(getID(this.mRS), 139, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), k, alpha.f367x, alpha.f368y, A.getID(this.mRS), B.getID(this.mRS), beta, 0.0f, C.getID(this.mRS), 0, 0, 0, 0);
    }
    ...
    public void ZHER2K(int Uplo2, int Trans, Double2 alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 142, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), k, alpha.f358x, alpha.f359y, A.getID(this.mRS), B.getID(this.mRS), beta, 0.0d, C.getID(this.mRS), 0, 0, 0, 0);
    }

    public void BNNM(Allocation A, int a_offset, Allocation B, int b_offset, Allocation C, int c_offset, int c_mult) {
        validateL3(Element.m142U8(this.mRS), 111, 112, 0, A, B, C);
