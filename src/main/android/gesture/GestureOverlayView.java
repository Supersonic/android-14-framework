...
public class GestureOverlayView extends FrameLayout {
    ...
    public GestureOverlayView(Context context, AttributeSet attrs) {
        this(context, attrs, C4057R.attr.gestureOverlayViewStyle);
    }
    ...
    public GestureOverlayView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mInterpolator = new AccelerateDecelerateInterpolator();
        this.mFadingOut = new FadeOutRunnable();
        TypedArray a = context.obtainStyledAttributes(attrs, C4057R.styleable.GestureOverlayView, defStyleAttr, defStyleRes);
    ...
    private Rect touchMove(MotionEvent event) {
        ...
        float x = event.getX();
        float y = event.getY();
        float previousX = this.f56mX;
        float previousY = this.f57mY;
