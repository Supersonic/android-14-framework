...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray attributesArray = context.obtainStyledAttributes(attrs, C4057R.styleable.ActivityChooserView, defStyleAttr, defStyleRes);
        saveAttributeDataForStyleable(context, C4057R.styleable.ActivityChooserView, attrs, attributesArray, defStyleAttr, defStyleRes);
        ...
        inflater.inflate(C4057R.layout.activity_chooser_view, (ViewGroup) this, true);
        Callbacks callbacks = new Callbacks();
        this.mCallbacks = callbacks;
        LinearLayout linearLayout = (LinearLayout) findViewById(C4057R.C4059id.activity_chooser_view_content);
        this.mActivityChooserContent = linearLayout;
        this.mActivityChooserContentBackground = linearLayout.getBackground();
        FrameLayout frameLayout = (FrameLayout) findViewById(C4057R.C4059id.default_activity_button);
        ...
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(C4057R.C4059id.image);
        FrameLayout expandButton = (FrameLayout) findViewById(C4057R.C4059id.expand_activities_button);
        ...
        ImageView imageView = (ImageView) expandButton.findViewById(C4057R.C4059id.image);
        ...
        this.mListPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(C4057R.dimen.config_prefDialogWidth));
    }
    ...
    public void showPopupUnchecked(int maxActivityCount) {
        ...
        if (!popupWindow.isShowing()) {
            ...
            popupWindow.getListView().setContentDescription(this.mContext.getString(C4057R.string.activitychooserview_choose_application));
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        private void startActivity(Intent intent, ResolveInfo resolveInfo) {
            try {
                ...
                String message = ActivityChooserView.this.mContext.getString(C4057R.string.activitychooserview_choose_application_error, appLabel);
                Log.m110e(ActivityChooserView.LOG_TAG, message);
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            switch (itemViewType) {
                case 0:
                    if (convertView == null || convertView.getId() != 16909195) {
                        convertView = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C4057R.layout.activity_chooser_view_list_item, parent, false);
                    }
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        View convertView2 = LayoutInflater.from(ActivityChooserView.this.getContext()).inflate(C4057R.layout.activity_chooser_view_list_item, parent, false);
                        convertView2.setId(1);
                        TextView titleView2 = (TextView) convertView2.findViewById(16908310);
                        titleView2.setText(ActivityChooserView.this.mContext.getString(C4057R.string.activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                default:
