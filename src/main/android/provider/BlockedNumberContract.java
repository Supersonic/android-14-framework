...
public class BlockedNumberContract {
    ...
    public static boolean isBlocked(Context context, String phoneNumber) {
        try {
            ...
            Log.m138d(LOG_TAG, "isBlocked: phoneNumber=%s, isBlocked=%b", Log.piiHandle(phoneNumber), Boolean.valueOf(isBlocked));
            return isBlocked;
        } catch (IllegalArgumentException | NullPointerException e) {
            Log.m130w((String) null, "isBlocked: provider not ready.", new Object[0]);
            return false;
        }
    }

    public static int unblock(Context context, String phoneNumber) {
        Log.m138d(LOG_TAG, "unblock: phoneNumber=%s", Log.piiHandle(phoneNumber));
    ...
    public static boolean canCurrentUserBlockNumbers(Context context) {
        try {
            ...
            Log.m130w((String) null, "canCurrentUserBlockNumbers: provider not ready.", new Object[0]);
            return false;
        }
    }
    ...
    public static class SystemContract {
        ...
        public static void notifyEmergencyContact(Context context) {
            try {
                Log.m134i(BlockedNumberContract.LOG_TAG, "notifyEmergencyContact; caller=%s", context.getOpPackageName());
                ...
                Log.m130w((String) null, "notifyEmergencyContact: provider not ready.", new Object[0]);
            }
        }

        public static void endBlockSuppression(Context context) {
            String caller = context.getOpPackageName();
            Log.m134i(BlockedNumberContract.LOG_TAG, "endBlockSuppression: caller=%s", caller);
        ...
        public static int shouldSystemBlockNumber(Context context, String phoneNumber, Bundle extras) {
            ...
            try {
                ...
                Log.m138d(BlockedNumberContract.LOG_TAG, "shouldSystemBlockNumber: number=%s, caller=%s, result=%s", Log.piiHandle(phoneNumber), caller, blockStatusToString(blockResult));
                return blockResult;
            } catch (IllegalArgumentException | NullPointerException e) {
                Log.m130w((String) null, "shouldSystemBlockNumber: provider not ready.", new Object[0]);
                return 0;
            }
        }
        ...
        public static BlockSuppressionStatus getBlockSuppressionStatus(Context context) {
            ...
            Log.m138d(BlockedNumberContract.LOG_TAG, "getBlockSuppressionStatus: caller=%s, status=%s", context.getOpPackageName(), blockSuppressionStatus);
        ...
        public static boolean shouldShowEmergencyCallNotification(Context context) {
            try {
                ...
                Log.m130w((String) null, "shouldShowEmergencyCallNotification: provider not ready.", new Object[0]);
                return false;
            }
        }
        ...
        public static boolean getEnhancedBlockSetting(Context context, String key) {
            ...
            try {
                ...
                Log.m130w((String) null, "getEnhancedBlockSetting: provider not ready.", new Object[0]);
                return false;
            }
        }
