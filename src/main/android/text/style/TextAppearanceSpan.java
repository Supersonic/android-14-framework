...
public class TextAppearanceSpan extends MetricAffectingSpan implements ParcelableSpan {
    ...
    public TextAppearanceSpan(Context context, int appearance, int colorList) {
        TypedArray a = context.obtainStyledAttributes(appearance, C4057R.styleable.TextAppearance);
        ...
        a.recycle();
        if (colorList >= 0) {
            TypedArray a2 = context.obtainStyledAttributes(16973829, C4057R.styleable.Theme);
