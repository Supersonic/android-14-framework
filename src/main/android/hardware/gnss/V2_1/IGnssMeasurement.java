...
public interface IGnssMeasurement extends android.hardware.gnss.V2_0.IGnssMeasurement {
    ...
    @Override // android.hardware.gnss.V2_0.IGnssMeasurement, android.hardware.gnss.V1_1.IGnssMeasurement, android.hardware.gnss.V1_0.IGnssMeasurement, android.internal.hidl.base.V1_0.IBase, android.p008os.IHwInterface
    IHwBinder asBinder();
    ...
    public static final class Proxy implements IGnssMeasurement {
        ...
        @Override // android.hardware.gnss.V2_1.IGnssMeasurement, android.hardware.gnss.V2_0.IGnssMeasurement, android.hardware.gnss.V1_1.IGnssMeasurement, android.hardware.gnss.V1_0.IGnssMeasurement, android.internal.hidl.base.V1_0.IBase, android.p008os.IHwInterface
