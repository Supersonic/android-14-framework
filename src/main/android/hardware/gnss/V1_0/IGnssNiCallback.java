...
public interface IGnssNiCallback extends IBase {
    ...
    public static final class Proxy implements IGnssNiCallback {
        ...
        @Override // android.hardware.gnss.V1_0.IGnssNiCallback, android.internal.hidl.base.V1_0.IBase, android.p008os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IGnssNiCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-57, -127, -73, -79, 37, -10, -117, -27, -37, -118, -116, 61, 65, 45, 82, 106, -51, -67, -9, 125, -52, 89, 42, 76, AcquiredInfo.POWER_PRESS, -41, 11, -116, -28, -2, 108, 73}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
