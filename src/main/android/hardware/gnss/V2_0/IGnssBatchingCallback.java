...
public interface IGnssBatchingCallback extends IBase {
    ...
    public static final class Proxy implements IGnssBatchingCallback {
        ...
        @Override // android.hardware.gnss.V2_0.IGnssBatchingCallback, android.internal.hidl.base.V1_0.IBase, android.p008os.IHwInterface
    ...
    public static abstract class Stub extends HwBinder implements IGnssBatchingCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{31, -119, 57, 47, 30, -69, 105, 61, -113, -90, -11, 3, 36, -79, 99, 95, -57, -97, -85, 36, 109, 49, MidiConstants.STATUS_NOTE_ON, AcquiredInfo.POWER_PRESS, 99, -103, -114, GsmAlphabet.GSM_EXTENDED_ESCAPE, AcquiredInfo.POWER_PRESS, 23, 81, 28}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
