...
public interface IUsbCallback extends IBase {
    ...
    static IUsbCallback asInterface(IHwBinder iHwBinder) {
        ...
        try {
            ...
            while (it.hasNext()) {
                if (it.next().equals("android.hardware.usb@1.0::IUsbCallback")) {
                    return proxy;
                }
            }
    ...
    public static abstract class Stub extends HwBinder implements IUsbCallback {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{75, -25, -120, 30, 65, 27, -92, 39, -124, -65, 91, 115, 84, -63, 74, -32, -49, 22, 16, 4, -45, -108, 51, -86, -20, -86, -80, -47, -98, -87, -109, 84}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
