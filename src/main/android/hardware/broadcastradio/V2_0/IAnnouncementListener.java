...
public interface IAnnouncementListener extends IBase {
    ...
    static IAnnouncementListener asInterface(IHwBinder iHwBinder) {
        ...
        try {
            ...
            while (it.hasNext()) {
                if (it.next().equals("android.hardware.broadcastradio@2.0::IAnnouncementListener")) {
                    return proxy;
                }
            }
    ...
    public static abstract class Stub extends HwBinder implements IAnnouncementListener {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{61, -114, -42, 125, Byte.MIN_VALUE, 126, -97, 21, -48, 112, -125, -112, -92, 22, -66, -32, 9, 32, -10, -94, 33, -106, -63, 4, -52, -98, 68, 60, -115, 33, 125, -8}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
