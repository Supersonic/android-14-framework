...
/* renamed from: android.hardware.tv.cec.V1_1.IHdmiCec */
...
public interface IHdmiCec extends android.hardware.p002tv.cec.V1_0.IHdmiCec {
    ...
    static IHdmiCec asInterface(IHwBinder iHwBinder) {
        ...
        try {
            ...
            while (it.hasNext()) {
                if (it.next().equals("android.hardware.tv.cec@1.1::IHdmiCec")) {
                    return proxy;
                }
            }
    ...
    /* renamed from: android.hardware.tv.cec.V1_1.IHdmiCec$Proxy */
    /* loaded from: classes.dex */
    ...
    /* renamed from: android.hardware.tv.cec.V1_1.IHdmiCec$Stub */
    /* loaded from: classes.dex */
