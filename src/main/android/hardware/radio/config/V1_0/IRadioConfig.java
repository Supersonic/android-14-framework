...
public interface IRadioConfig extends IBase {
    ...
    static IRadioConfig asInterface(IHwBinder iHwBinder) {
        ...
        IRadioConfig queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.radio.config@1.0::IRadioConfig");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (it.next().equals("android.hardware.radio.config@1.0::IRadioConfig")) {
                    return proxy;
                }
            }
    ...
    static IRadioConfig getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService("android.hardware.radio.config@1.0::IRadioConfig", str, z));
    }
