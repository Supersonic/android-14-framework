...
public interface IRadioConfig extends android.hardware.radio.config.V1_1.IRadioConfig {
    ...
    static IRadioConfig asInterface(IHwBinder iHwBinder) {
        ...
        IRadioConfig queryLocalInterface = iHwBinder.queryLocalInterface("android.hardware.radio.config@1.3::IRadioConfig");
        ...
        try {
            ...
            while (it.hasNext()) {
                if (it.next().equals("android.hardware.radio.config@1.3::IRadioConfig")) {
                    return proxy;
                }
            }
    ...
    static IRadioConfig getService(String str, boolean z) throws RemoteException {
        return asInterface(HwBinder.getService("android.hardware.radio.config@1.3::IRadioConfig", str, z));
    }
    ...
    public static final class Proxy implements IRadioConfig {
        ...
        @Override // android.hardware.radio.config.V1_3.IRadioConfig
        public void getHalDeviceCapabilities(int i) throws RemoteException {
            HwParcel hwParcel = new HwParcel();
            hwParcel.writeInterfaceToken("android.hardware.radio.config@1.3::IRadioConfig");
            hwParcel.writeInt32(i);
            HwParcel hwParcel2 = new HwParcel();
            try {
        ...
        @Override // android.hardware.radio.config.V1_3.IRadioConfig, android.hardware.radio.config.V1_1.IRadioConfig, android.hardware.radio.config.V1_0.IRadioConfig
