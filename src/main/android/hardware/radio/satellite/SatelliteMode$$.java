...
public interface SatelliteMode$$ {
    static String toString(int _aidl_v) {
        return _aidl_v == 0 ? "POWERED_OFF" : _aidl_v == 1 ? "OUT_OF_SERVICE_NOT_SEARCHING" : _aidl_v == 2 ? "OUT_OF_SERVICE_SEARCHING" : _aidl_v == 3 ? "ACQUIRED" : _aidl_v == 4 ? "MESSAGE_TRANSFERRING" : Integer.toString(_aidl_v);
    }
