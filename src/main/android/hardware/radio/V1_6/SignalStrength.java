...
public final class SignalStrength {
    ...
    /* renamed from: nr */
    public NrSignalStrength f189nr = new NrSignalStrength();
    ...
    public final boolean equals(Object otherObject) {
        ...
        if (HidlSupport.deepEquals(this.gsm, other.gsm) && HidlSupport.deepEquals(this.cdma, other.cdma) && HidlSupport.deepEquals(this.evdo, other.evdo) && HidlSupport.deepEquals(this.lte, other.lte) && HidlSupport.deepEquals(this.tdscdma, other.tdscdma) && HidlSupport.deepEquals(this.wcdma, other.wcdma) && HidlSupport.deepEquals(this.f189nr, other.f189nr)) {
            return true;
        }
        return false;
    }
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f189nr.readEmbeddedFromParcel(parcel, _hidl_blob, 88 + _hidl_offset);
    }
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        this.f189nr.writeEmbeddedToBlob(_hidl_blob, 88 + _hidl_offset);
    }
}
