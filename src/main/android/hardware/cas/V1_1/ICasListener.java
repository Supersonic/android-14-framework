...
public interface ICasListener extends android.hardware.cas.V1_0.ICasListener {
    ...
    @Override // android.hardware.cas.V1_0.ICasListener, android.internal.hidl.base.V1_0.IBase, android.p008os.IHwInterface
    IHwBinder asBinder();
    ...
    public static abstract class Stub extends HwBinder implements ICasListener {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{37, 1, 45, 23, 120, -9, 57, 111, -106, 123, -68, 2, 49, 57, 125, 84, 75, -34, 66, GsmAlphabet.GSM_EXTENDED_ESCAPE, -91, -71, -121, 6, -55, -28, -118, -57, MidiConstants.STATUS_NOTE_ON, 97, 38, -125}, new byte[]{-72, AcquiredInfo.POWER_PRESS, IGnssVisibilityControlCallback.NfwRequestor.AUTOMOBILE_CLIENT, 86, -72, 31, Byte.MIN_VALUE, 3, 45, 13, -25, -53, 69, 101, 42, -63, 90, MidiConstants.STATUS_MIDI_TIME_CODE, 30, 116, 116, -43, NetworkStackConstants.TCPHDR_URG, -41, 87, 72, 30, -54, -83, 121, 109, -1}, new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
