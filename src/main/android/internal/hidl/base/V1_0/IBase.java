...
public interface IBase extends IHwInterface {
    ...
    @Override // android.p008os.IHwInterface
    IHwBinder asBinder();
    ...
    public static abstract class Stub extends HwBinder implements IBase {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Collections.singletonList(new byte[]{-20, Byte.MAX_VALUE, -41, -98, MidiConstants.STATUS_CHANNEL_PRESSURE, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, MidiConstants.STATUS_SONG_SELECT, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
