...
public final class DynamicsProcessing extends AudioEffect {
    ...
    public DynamicsProcessing(int priority, int audioSession, Config cfg) {
        ...
        if (audioSession == 0) {
            Log.m104w(TAG, "WARNING: attaching a DynamicsProcessing to global output mix isdeprecated!");
        }
    ...
    /* loaded from: classes2.dex */
    public static final class C1815Eq extends BandStage {
        private final EqBand[] mBands;

        public C1815Eq(boolean inUse, boolean enabled, int bandCount) {
    ...
    public static final class Channel {
        ...
        private Mbc mMbc;
        private C1815Eq mPostEq;
        private C1815Eq mPreEq;
        ...
        public Channel(float inputGain, boolean preEqInUse, int preEqBandCount, boolean mbcInUse, int mbcBandCount, boolean postEqInUse, int postEqBandCount, boolean limiterInUse) {
            ...
            this.mPreEq = new C1815Eq(preEqInUse, true, preEqBandCount);
            this.mMbc = new Mbc(mbcInUse, true, mbcBandCount);
            this.mPostEq = new C1815Eq(postEqInUse, true, postEqBandCount);
        ...
        public Channel(Channel cfg) {
            ...
            this.mPreEq = new C1815Eq(cfg.mPreEq);
            this.mMbc = new Mbc(cfg.mMbc);
            this.mPostEq = new C1815Eq(cfg.mPostEq);
        ...
        public C1815Eq getPreEq() {
            return this.mPreEq;
        }

        public void setPreEq(C1815Eq preEq) {
        ...
        public C1815Eq getPostEq() {
            return this.mPostEq;
        }

        public void setPostEq(C1815Eq postEq) {
            ...
            this.mPostEq = new C1815Eq(postEq);
        }
    ...
    public static final class Config {
        ...
        public C1815Eq getPreEqByChannelIndex(int channelIndex) {
            checkChannel(channelIndex);
            return this.mChannel[channelIndex].getPreEq();
        }

        public void setPreEqByChannelIndex(int channelIndex, C1815Eq preEq) {
            checkChannel(channelIndex);
            this.mChannel[channelIndex].setPreEq(preEq);
        }

        public void setPreEqAllChannelsTo(C1815Eq preEq) {
            int ch = 0;
            while (true) {
                Channel[] channelArr = this.mChannel;
                if (ch < channelArr.length) {
        ...
        public C1815Eq getPostEqByChannelIndex(int channelIndex) {
            checkChannel(channelIndex);
            return this.mChannel[channelIndex].getPostEq();
        }

        public void setPostEqByChannelIndex(int channelIndex, C1815Eq postEq) {
            checkChannel(channelIndex);
            this.mChannel[channelIndex].setPostEq(postEq);
        }

        public void setPostEqAllChannelsTo(C1815Eq postEq) {
            int ch = 0;
            while (true) {
                Channel[] channelArr = this.mChannel;
                if (ch < channelArr.length) {
        ...
        public static final class Builder {
            ...
            public Builder setPreEqByChannelIndex(int channelIndex, C1815Eq preEq) {
                checkChannel(channelIndex);
                this.mChannel[channelIndex].setPreEq(preEq);
                return this;
            }

            public Builder setPreEqAllChannelsTo(C1815Eq preEq) {
                for (int ch = 0; ch < this.mChannel.length; ch++) {
            ...
            public Builder setPostEqByChannelIndex(int channelIndex, C1815Eq postEq) {
                checkChannel(channelIndex);
                this.mChannel[channelIndex].setPostEq(postEq);
                return this;
            }

            public Builder setPostEqAllChannelsTo(C1815Eq postEq) {
                for (int ch = 0; ch < this.mChannel.length; ch++) {
    ...
    private C1815Eq queryEngineEqByChannelIndex(int param, int channelIndex) {
        ...
        C1815Eq eq = new C1815Eq(values[0].intValue() > 0, values[1].intValue() > 0, bandCount);
        for (int b = 0; b < bandCount; b++) {
    ...
    private void updateEngineEqByChannelIndex(int param, int channelIndex, C1815Eq eq) {
    ...
    private Channel queryEngineByChannelIndex(int channelIndex) {
        ...
        C1815Eq preEq = queryEngineEqByChannelIndex(64, channelIndex);
        Mbc mbc = queryEngineMbcByChannelIndex(channelIndex);
        C1815Eq postEq = queryEngineEqByChannelIndex(96, channelIndex);
    ...
    private void updateEngineChannelByChannelIndex(int channelIndex, Channel channel) {
        ...
        C1815Eq preEq = channel.getPreEq();
        updateEngineEqByChannelIndex(64, channelIndex, preEq);
        Mbc mbc = channel.getMbc();
        updateEngineMbcByChannelIndex(channelIndex, mbc);
        C1815Eq postEq = channel.getPostEq();
        updateEngineEqByChannelIndex(96, channelIndex, postEq);
