...
public enum FieldType {
    ...
    FieldType(int id, Collection collection, JavaType javaType) {
        ...
        switch (C40081.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()]) {
            case 1:
        ...
        if (collection == Collection.SCALAR) {
            switch (C40081.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) {
                case 1:
                case 2:
                case 3:
                    break;
