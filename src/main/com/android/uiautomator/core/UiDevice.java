...
public class UiDevice {
    ...
    public boolean waitForWindowUpdate(final String packageName, long timeout) {
        ...
        Runnable emptyRunnable = new Runnable() { // from class: com.android.uiautomator.core.UiDevice.1
            @Override // java.lang.Runnable
            public void run() {
            }
        };
        UiAutomation.AccessibilityEventFilter checkWindowUpdate = new UiAutomation.AccessibilityEventFilter() { // from class: com.android.uiautomator.core.UiDevice.2
            @Override // android.app.UiAutomation.AccessibilityEventFilter
            public boolean accept(AccessibilityEvent t) {
                if (t.getEventType() == 2048) {
                    String str = packageName;
                    return str == null || str.equals(t.getPackageName());
                }
                return false;
            }
        };
