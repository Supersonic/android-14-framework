...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style) {
        this(toolbar, style, C4057R.string.action_bar_up_description);
    }
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription) {
        ...
        TypedArray a = toolbar.getContext().obtainStyledAttributes(null, C4057R.styleable.ActionBar, 16843470, 0);
    ...
    public void initProgress() {
        Log.m108i(TAG, "Progress display unsupported");
    }
    ...
    public void setMenu(Menu menu, MenuPresenter.Callback cb) {
        if (this.mActionMenuPresenter == null) {
            ...
            actionMenuPresenter.setId(C4057R.C4059id.action_menu_presenter);
        }
