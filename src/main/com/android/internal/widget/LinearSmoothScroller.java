...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    protected int getHorizontalSnapPreference() {
        ...
        if (pointF == null || pointF.f78x == 0.0f) {
            return 0;
        }
        return this.mTargetVector.f78x > 0.0f ? 1 : -1;
    }

    protected int getVerticalSnapPreference() {
        PointF pointF = this.mTargetVector;
        if (pointF == null || pointF.f79y == 0.0f) {
            return 0;
        }
        return this.mTargetVector.f79y > 0.0f ? 1 : -1;
    }

    protected void updateActionForInterimTarget(RecyclerView.SmoothScroller.Action action) {
        PointF scrollVector = computeScrollVectorForPosition(getTargetPosition());
        if (scrollVector == null || (scrollVector.f78x == 0.0f && scrollVector.f79y == 0.0f)) {
        ...
        this.mInterimTargetDx = (int) (scrollVector.f78x * 10000.0f);
        this.mInterimTargetDy = (int) (scrollVector.f79y * 10000.0f);
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        Log.m104w(TAG, "You should override computeScrollVectorForPosition when the LayoutManager does not implement " + RecyclerView.SmoothScroller.ScrollVectorProvider.class.getCanonicalName());
        return null;
    }
}
