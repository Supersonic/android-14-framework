...
public abstract class AbsActionBarView extends ViewGroup {
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(null, C4057R.styleable.ActionBar, 16843470, 0);
        setContentHeight(a.getLayoutDimension(4, 0));
        a.recycle();
        if (this.mSplitWhenNarrow) {
            setSplitToolbar(getContext().getResources().getBoolean(C4057R.bool.split_action_bar_is_narrow));
        }
