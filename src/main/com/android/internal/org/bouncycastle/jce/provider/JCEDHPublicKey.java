...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    public byte[] getEncoded() {
        ...
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f819y));
    }
    ...
    private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
        this.f819y = (BigInteger) in.readObject();
