...
public class SECNamedCurves {
    static X9ECParametersHolder secp112r1 = new X9ECParametersHolder() { // from class: com.android.internal.org.bouncycastle.asn1.sec.SECNamedCurves.1
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = SECNamedCurves.configureCurve(new ECCurve.C4297Fp(p, a, b, n, h));
    ...
    static X9ECParametersHolder secp160k1 = new X9ECParametersHolder() { // from class: com.android.internal.org.bouncycastle.asn1.sec.SECNamedCurves.5
        ...
        protected X9ECParameters createParameters() {
            ...
            ECCurve curve = SECNamedCurves.configureCurveGLV(new ECCurve.C4297Fp(p, a, b, n, h), glv);
