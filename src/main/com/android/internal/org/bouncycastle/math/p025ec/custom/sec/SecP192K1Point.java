...
/* renamed from: com.android.internal.org.bouncycastle.math.ec.custom.sec.SecP192K1Point */
...
public class SecP192K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        SecP192K1FieldElement X1 = (SecP192K1FieldElement) this.f847x;
        SecP192K1FieldElement Y1 = (SecP192K1FieldElement) this.f848y;
        SecP192K1FieldElement X2 = (SecP192K1FieldElement) b.getXCoord();
        SecP192K1FieldElement Y2 = (SecP192K1FieldElement) b.getYCoord();
        SecP192K1FieldElement Z1 = (SecP192K1FieldElement) this.f849zs[0];
        ...
        if (Z1IsOne) {
            ...
            S2 = t3;
            SecP192K1Field.square(Z1.f856x, S2);
            U2 = t2;
            SecP192K1Field.multiply(S2, X2.f856x, U2);
            SecP192K1Field.multiply(S2, Z1.f856x, S2);
            SecP192K1Field.multiply(S2, Y2.f856x, S2);
        }
        ...
        if (Z2IsOne) {
            ...
            SecP192K1Field.square(Z2.f856x, t4);
            SecP192K1Field.multiply(t4, X1.f856x, tt1);
            SecP192K1Field.multiply(t4, Z2.f856x, t4);
            SecP192K1Field.multiply(t4, Y1.f856x, t4);
            S1 = t4;
            S12 = tt1;
        }
        int[] H = Nat192.create();
        ...
        int[] HSquared = X3.f856x;
        SecP192K1Field.square(t2, HSquared);
        int[] iArr = X3.f856x;
        int[] S13 = X3.f856x;
        SecP192K1Field.subtract(iArr, G, S13);
        SecP192K1FieldElement Y3 = new SecP192K1FieldElement(G);
        SecP192K1Field.subtract(t3, X3.f856x, Y3.f856x);
        SecP192K1Field.multiplyAddToExt(Y3.f856x, t2, tt1);
        SecP192K1Field.reduce(tt1, Y3.f856x);
        SecP192K1FieldElement Z3 = new SecP192K1FieldElement(H);
        if (!Z1IsOne) {
            int[] iArr2 = Z3.f856x;
            int[] R = Z1.f856x;
            SecP192K1Field.multiply(iArr2, R, Z3.f856x);
        }
        if (!Z2IsOne) {
            SecP192K1Field.multiply(Z3.f856x, Z2.f856x, Z3.f856x);
        }
    ...
    public ECPoint twice() {
        ...
        SecP192K1Field.square(Y1.f856x, Y1Squared);
        int[] T = Nat192.create();
        SecP192K1Field.square(Y1Squared, T);
        int[] M = Nat192.create();
        SecP192K1Field.square(X1.f856x, M);
        int c = Nat192.addBothTo(M, M, M);
        SecP192K1Field.reduce32(c, M);
        SecP192K1Field.multiply(Y1Squared, X1.f856x, Y1Squared);
        ...
        SecP192K1Field.square(M, X3.f856x);
        SecP192K1Field.subtract(X3.f856x, Y1Squared, X3.f856x);
        SecP192K1Field.subtract(X3.f856x, Y1Squared, X3.f856x);
        SecP192K1FieldElement Y3 = new SecP192K1FieldElement(Y1Squared);
        SecP192K1Field.subtract(Y1Squared, X3.f856x, Y3.f856x);
        SecP192K1Field.multiply(Y3.f856x, M, Y3.f856x);
        SecP192K1Field.subtract(Y3.f856x, t1, Y3.f856x);
        SecP192K1FieldElement Z3 = new SecP192K1FieldElement(M);
        SecP192K1Field.twice(Y1.f856x, Z3.f856x);
        if (!Z1.isOne()) {
            SecP192K1Field.multiply(Z3.f856x, Z1.f856x, Z3.f856x);
        }
    ...
    public ECPoint negate() {
        ...
        return new SecP192K1Point(this.curve, this.f847x, this.f848y.negate(), this.f849zs);
    }
}
