...
/* renamed from: com.android.internal.org.bouncycastle.math.ec.custom.sec.SecP192R1Point */
...
public class SecP192R1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint add(ECPoint b) {
        ...
        SecP192R1FieldElement X1 = (SecP192R1FieldElement) this.f847x;
        SecP192R1FieldElement Y1 = (SecP192R1FieldElement) this.f848y;
        SecP192R1FieldElement X2 = (SecP192R1FieldElement) b.getXCoord();
        SecP192R1FieldElement Y2 = (SecP192R1FieldElement) b.getYCoord();
        SecP192R1FieldElement Z1 = (SecP192R1FieldElement) this.f849zs[0];
        ...
        if (Z1IsOne) {
            ...
            S2 = t3;
            SecP192R1Field.square(Z1.f862x, S2);
            U2 = t2;
            SecP192R1Field.multiply(S2, X2.f862x, U2);
            SecP192R1Field.multiply(S2, Z1.f862x, S2);
            SecP192R1Field.multiply(S2, Y2.f862x, S2);
        }
        ...
        if (Z2IsOne) {
            ...
            SecP192R1Field.square(Z2.f862x, t4);
            SecP192R1Field.multiply(t4, X1.f862x, tt1);
            SecP192R1Field.multiply(t4, Z2.f862x, t4);
            SecP192R1Field.multiply(t4, Y1.f862x, t4);
            S1 = t4;
            S12 = tt1;
        }
        int[] H = Nat192.create();
        ...
        int[] HSquared = X3.f862x;
        SecP192R1Field.square(t2, HSquared);
        int[] iArr = X3.f862x;
        int[] S13 = X3.f862x;
        SecP192R1Field.subtract(iArr, G, S13);
        SecP192R1FieldElement Y3 = new SecP192R1FieldElement(G);
        SecP192R1Field.subtract(t3, X3.f862x, Y3.f862x);
        SecP192R1Field.multiplyAddToExt(Y3.f862x, t2, tt1);
        SecP192R1Field.reduce(tt1, Y3.f862x);
        SecP192R1FieldElement Z3 = new SecP192R1FieldElement(H);
        if (!Z1IsOne) {
            int[] iArr2 = Z3.f862x;
            int[] R = Z1.f862x;
            SecP192R1Field.multiply(iArr2, R, Z3.f862x);
        }
        if (!Z2IsOne) {
            SecP192R1Field.multiply(Z3.f862x, Z2.f862x, Z3.f862x);
        }
    ...
    public ECPoint twice() {
        ...
        SecP192R1Field.square(Y1.f862x, Y1Squared);
        int[] T = Nat192.create();
        SecP192R1Field.square(Y1Squared, T);
        boolean Z1IsOne = Z1.isOne();
        int[] Z1Squared = Z1.f862x;
        if (!Z1IsOne) {
            Z1Squared = t2;
            SecP192R1Field.square(Z1.f862x, Z1Squared);
        }
        SecP192R1Field.subtract(X1.f862x, Z1Squared, t1);
        SecP192R1Field.add(X1.f862x, Z1Squared, t2);
        SecP192R1Field.multiply(t2, t1, t2);
        int c = Nat192.addBothTo(t2, t2, t2);
        SecP192R1Field.reduce32(c, t2);
        SecP192R1Field.multiply(Y1Squared, X1.f862x, Y1Squared);
        ...
        SecP192R1Field.square(t2, X3.f862x);
        SecP192R1Field.subtract(X3.f862x, Y1Squared, X3.f862x);
        SecP192R1Field.subtract(X3.f862x, Y1Squared, X3.f862x);
        SecP192R1FieldElement Y3 = new SecP192R1FieldElement(Y1Squared);
        SecP192R1Field.subtract(Y1Squared, X3.f862x, Y3.f862x);
        SecP192R1Field.multiply(Y3.f862x, t2, Y3.f862x);
        SecP192R1Field.subtract(Y3.f862x, t1, Y3.f862x);
        SecP192R1FieldElement Z3 = new SecP192R1FieldElement(t2);
        SecP192R1Field.twice(Y1.f862x, Z3.f862x);
        if (!Z1IsOne) {
            SecP192R1Field.multiply(Z3.f862x, Z1.f862x, Z3.f862x);
        }
    ...
    public ECPoint negate() {
        ...
        return new SecP192R1Point(this.curve, this.f847x, this.f848y.negate(), this.f849zs);
    }
}
