...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    /* renamed from: c */
    private TBSCertList.CRLEntry f808c;
    ...
    private Set getExtensionOIDs(boolean critical) {
        Extensions extensions = this.f808c.getExtensions();
        if (extensions != null) {
            Set set = new HashSet();
    ...
    private Extension getExtension(ASN1ObjectIdentifier oid) {
        Extensions exts = this.f808c.getExtensions();
        if (exts != null) {
    ...
    public boolean equals(Object other) {
        ...
        if (other instanceof X509CRLEntryObject) {
            ...
            return this.f808c.equals(otherBC.f808c);
        }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f808c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public BigInteger getSerialNumber() {
        return this.f808c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public Date getRevocationDate() {
        return this.f808c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f808c.getExtensions() != null;
    }
