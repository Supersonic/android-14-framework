...
public final class MenuItemImpl implements MenuItem {
        ...
        if (onMenuItemClickListener == null || !onMenuItemClickListener.onMenuItemClick(this)) {
            ...
            if (this.mIntent != null) {
                try {
                    ...
                    Log.m109e(TAG, "Can't find activity to handle intent; ignoring", e);
                }
            }
    ...
    public String getShortcutLabel() {
        ...
        if (ViewConfiguration.get(this.mMenu.getContext()).hasPermanentMenuKey()) {
            sb.append(res.getString(C4057R.string.prepend_shortcut_label));
        }
        int modifiers = this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticModifiers : this.mShortcutNumericModifiers;
        appendModifier(sb, modifiers, 65536, res.getString(C4057R.string.menu_meta_shortcut_label));
        appendModifier(sb, modifiers, 4096, res.getString(C4057R.string.menu_ctrl_shortcut_label));
        appendModifier(sb, modifiers, 2, res.getString(C4057R.string.menu_alt_shortcut_label));
        appendModifier(sb, modifiers, 1, res.getString(C4057R.string.menu_shift_shortcut_label));
        appendModifier(sb, modifiers, 4, res.getString(C4057R.string.menu_sym_shortcut_label));
        appendModifier(sb, modifiers, 8, res.getString(C4057R.string.menu_function_shortcut_label));
        switch (shortcut) {
            case '\b':
                sb.append(res.getString(C4057R.string.menu_delete_shortcut_label));
                break;
            case '\n':
                sb.append(res.getString(C4057R.string.menu_enter_shortcut_label));
                break;
            case ' ':
                sb.append(res.getString(C4057R.string.menu_space_shortcut_label));
                break;
            default:
                sb.append(shortcut);
                break;
