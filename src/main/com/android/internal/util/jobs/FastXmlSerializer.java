...
public class FastXmlSerializer implements XmlSerializer {
    ...
    public final void append(char c) throws IOException {
        int i = this.mPos;
    ...
    public final void append(String str, int i, int i2) throws IOException {
    ...
    public final void append(char[] cArr, int i, int i2) throws IOException {
        int i3 = this.mBufferLen;
        if (i2 <= i3) {
            int i4 = this.mPos;
            if (i4 + i2 > i3) {
    ...
    public final void appendIndent(int i) throws IOException {
        int i2 = i * 4;
        if (i2 > sSpace.length()) {
            i2 = sSpace.length();
        }
    ...
    public final void escapeAndAppendString(String str) throws IOException {
        String str2;
    ...
    public final void escapeAndAppendString(char[] cArr, int i, int i2) throws IOException {
        String str;
        String[] strArr = ESCAPE_TABLE;
    ...
    public final void flushBytes() throws IOException {
