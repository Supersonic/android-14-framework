...
public class MimeIconUtils {
    ...
    private static ContentResolver.MimeTypeInfo buildTypeInfo(String mimeType) {
        ...
        switch (c) {
            case 0:
            case 1:
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_folder, C4057R.string.mime_type_folder, -1);
            case 2:
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_apk, C4057R.string.mime_type_apk, -1);
            case 3:
            case 4:
            case 5:
            case 6:
            ...
            case 11:
            case '\f':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_certificate, C4057R.string.mime_type_generic, C4057R.string.mime_type_generic_ext);
            case '\r':
            case 14:
            case 15:
            case 16:
            ...
            case '\'':
            case '(':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_codes, C4057R.string.mime_type_document, C4057R.string.mime_type_document_ext);
            case ')':
            case '*':
            case '+':
            case ',':
            ...
            case '9':
            case ':':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_compressed, C4057R.string.mime_type_compressed, C4057R.string.mime_type_compressed_ext);
            case ';':
            case '<':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_contact, C4057R.string.mime_type_generic, C4057R.string.mime_type_generic_ext);
            case '=':
            case '>':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_event, C4057R.string.mime_type_generic, C4057R.string.mime_type_generic_ext);
            case '?':
            case '@':
            case 'A':
            case 'B':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_font, C4057R.string.mime_type_generic, C4057R.string.mime_type_generic_ext);
            case 'C':
            case 'D':
            case 'E':
            case 'F':
            ...
            case 'H':
            case 'I':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_image, C4057R.string.mime_type_image, C4057R.string.mime_type_image_ext);
            case 'J':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_pdf, C4057R.string.mime_type_document, C4057R.string.mime_type_document_ext);
            case 'K':
            case 'L':
            case 'M':
            case 'N':
            case 'O':
            case 'P':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_presentation, C4057R.string.mime_type_presentation, C4057R.string.mime_type_presentation_ext);
            case 'Q':
            case 'R':
            case 'S':
            case 'T':
            ...
            case 'V':
            case 'W':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_spreadsheet, C4057R.string.mime_type_spreadsheet, C4057R.string.mime_type_spreadsheet_ext);
            case 'X':
            case 'Y':
            case 'Z':
            case '[':
            ...
            case 'b':
            case 'c':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_document, C4057R.string.mime_type_document, C4057R.string.mime_type_document_ext);
            case 'd':
            case 'e':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_video, C4057R.string.mime_type_video, C4057R.string.mime_type_video_ext);
            case 'f':
            case 'g':
            case 'h':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_word, C4057R.string.mime_type_document, C4057R.string.mime_type_document_ext);
            case 'i':
            case 'j':
            case 'k':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_excel, C4057R.string.mime_type_spreadsheet, C4057R.string.mime_type_spreadsheet_ext);
            case 'l':
            case 'm':
            case 'n':
            case 'o':
                return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_powerpoint, C4057R.string.mime_type_presentation, C4057R.string.mime_type_presentation_ext);
            default:
    ...
    private static ContentResolver.MimeTypeInfo buildGenericTypeInfo(String mimeType) {
        if (mimeType.startsWith("audio/")) {
            return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_audio, C4057R.string.mime_type_audio, C4057R.string.mime_type_audio_ext);
        }
        ...
        if (mimeType.startsWith("text/")) {
            return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_text, C4057R.string.mime_type_document, C4057R.string.mime_type_document_ext);
        }
        ...
        return buildTypeInfo(mimeType, C4057R.C4058drawable.ic_doc_generic, C4057R.string.mime_type_generic, C4057R.string.mime_type_generic_ext);
    }
