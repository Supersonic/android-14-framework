...
public abstract class ToggleAction implements Action {
    ...
    public View create(Context context, View convertView, ViewGroup parent, LayoutInflater inflater) {
        willCreate();
        View v = inflater.inflate(C4057R.layout.global_actions_item, parent, false);
        ImageView icon = (ImageView) v.findViewById(16908294);
        TextView messageView = (TextView) v.findViewById(16908299);
        TextView statusView = (TextView) v.findViewById(C4057R.C4059id.status);
    ...
    public final void onPress() {
        if (this.mState.inTransition()) {
            Log.m104w(TAG, "shouldn't be able to toggle when in transition");
            return;
        }
