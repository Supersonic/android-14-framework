...
public interface RILConstants {
    ...
    public static final int RIL_REQUEST_ADD_ALLOWED_SATELLITE_CONTACTS = 249;
    ...
    public static final int RIL_REQUEST_GET_MAX_CHARACTERS_PER_SATELLITE_TEXT_MESSAGE = 257;
    ...
    public static final int RIL_REQUEST_GET_PENDING_SATELLITE_MESSAGES = 252;
    ...
    public static final int RIL_REQUEST_GET_SATELLITE_CAPABILITIES = 245;
    public static final int RIL_REQUEST_GET_SATELLITE_MODE = 253;
    public static final int RIL_REQUEST_GET_SATELLITE_POWER = 247;
    ...
    public static final int RIL_REQUEST_GET_TIME_FOR_NEXT_SATELLITE_VISIBILITY = 258;
    ...
    public static final int RIL_REQUEST_PROVISION_SATELLITE_SERVICE = 248;
    ...
    public static final int RIL_REQUEST_REMOVE_ALLOWED_SATELLITE_CONTACTS = 250;
    ...
    public static final int RIL_REQUEST_SEND_SATELLITE_MESSAGES = 251;
    ...
    public static final int RIL_REQUEST_SET_SATELLITE_INDICATION_FILTER = 254;
    public static final int RIL_REQUEST_SET_SATELLITE_POWER = 246;
    ...
    public static final int RIL_REQUEST_START_SENDING_SATELLITE_POINTING_INFO = 255;
    ...
    public static final int RIL_REQUEST_STOP_SENDING_SATELLITE_POINTING_INFO = 256;
    ...
    public static final int RIL_UNSOL_NEW_SATELLITE_MESSAGES = 1057;
    ...
    public static final int RIL_UNSOL_PENDING_SATELLITE_MESSAGE_COUNT = 1056;
    ...
    public static final int RIL_UNSOL_SATELLITE_MESSAGES_TRANSFER_COMPLETE = 1058;
    public static final int RIL_UNSOL_SATELLITE_MODE_CHANGED = 1060;
    public static final int RIL_UNSOL_SATELLITE_POINTING_INFO_CHANGED = 1059;
    public static final int RIL_UNSOL_SATELLITE_PROVISION_STATE_CHANGED = 1062;
    public static final int RIL_UNSOL_SATELLITE_RADIO_TECHNOLOGY_CHANGED = 1061;
