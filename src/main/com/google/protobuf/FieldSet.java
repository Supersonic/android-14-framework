...
public final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    /* synthetic */ FieldSet(SmallSortedMap x0, C00161 x1) {
        this(x0);
    }
    ...
    public static boolean isValidType(WireFormat.FieldType type, Object value) {
        ...
        switch (C00161.$SwitchMap$com$google$protobuf$WireFormat$JavaType[type.getJavaType().ordinal()]) {
            case 1:
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C00161 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$google$protobuf$WireFormat$FieldType[WireFormat.FieldType.SINT32.ordinal()] = FieldSet.DEFAULT_FIELD_MAP_ARRAY_SIZE;
    ...
    static void writeElementNoTag(CodedOutputStream output, WireFormat.FieldType type, Object value) throws IOException {
        switch (C00161.$SwitchMap$com$google$protobuf$WireFormat$FieldType[type.ordinal()]) {
            case 1:
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private Builder() {
            this(SmallSortedMap.newFieldMap(FieldSet.DEFAULT_FIELD_MAP_ARRAY_SIZE));
        }
