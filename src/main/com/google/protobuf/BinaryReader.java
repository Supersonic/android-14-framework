...
abstract class BinaryReader implements Reader {
    ...
    /* synthetic */ BinaryReader(C00051 x0) {
        this();
    }
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        private Object readField(WireFormat.FieldType fieldType, Class<?> messageType, ExtensionRegistryLite extensionRegistry) throws IOException {
            switch (C00051.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
                case 1:
                ...
                case BinaryReader.FIXED64_MULTIPLE_MASK /* 7 */:
        ...
        private long readVarint64SlowPath() throws IOException {
            long result = 0;
            for (int shift = 0; shift < 64; shift += BinaryReader.FIXED64_MULTIPLE_MASK) {
                byte b = readByte();
        ...
        private long readLittleEndian64_NoCheck() {
            ...
            byte[] buffer = this.buffer;
            this.pos = p + 8;
            return (buffer[p] & 255) | ((buffer[p + 1] & 255) << 8) | ((buffer[p + 2] & 255) << 16) | ((buffer[p + 3] & 255) << 24) | ((buffer[p + 4] & 255) << 32) | ((buffer[p + 5] & 255) << 40) | ((buffer[p + 6] & 255) << 48) | ((255 & buffer[p + BinaryReader.FIXED64_MULTIPLE_MASK]) << 56);
        }
        ...
        private void verifyPackedFixed64Length(int bytes) throws IOException {
            requireBytes(bytes);
            if ((bytes & BinaryReader.FIXED64_MULTIPLE_MASK) != 0) {
                throw InvalidProtocolBufferException.parseFailure();
            }
        }
    ...
    public static /* synthetic */ class C00051 {
        ...
        static {
            ...
            try {
                $SwitchMap$com$google$protobuf$WireFormat$FieldType[WireFormat.FieldType.FLOAT.ordinal()] = BinaryReader.FIXED64_MULTIPLE_MASK;
