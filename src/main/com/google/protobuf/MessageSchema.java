...
public final class MessageSchema<T> implements Schema<T> {
    ...
    static <T> MessageSchema<T> newSchemaForRawMessageInfo(RawMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        while (i27 < length) {
            ...
            buffer[bufferIndex2] = ((result22 & 512) != 0 ? ENFORCE_UTF8_MASK : 0) | ((result22 & 256) != 0 ? REQUIRED_MASK : 0) | (fieldType << OFFSET_BITS) | fieldOffset;
            bufferIndex = bufferIndex3 + 1;
            buffer[bufferIndex3] = (presenceMaskShift << OFFSET_BITS) | presenceFieldOffset;
            info2 = info;
    ...
    */
    static <T> MessageSchema<T> newSchemaForMessageInfo(StructuralMessageInfo messageInfo, NewInstanceSchema newInstanceSchema, ListFieldSchema listFieldSchema, UnknownFieldSchema<?, ?> unknownFieldSchema, ExtensionSchema<?> extensionSchema, MapFieldSchema mapFieldSchema) {
        ...
        for (FieldInfo fi : fis) {
            if (fi.getType() == FieldType.MAP) {
                mapFieldCount++;
            } else if (fi.getType().m1id() >= 18 && fi.getType().m1id() <= 49) {
                repeatedFieldCount++;
            }
        }
        ...
        while (checkInitializedIndex2 < repeatedFieldCount) {
            ...
            if (fi2.getType() == FieldType.MAP) {
                ...
                mapFieldCount2++;
                isProto3 = isProto32;
            } else if (fi2.getType().m1id() < 18 || fi2.getType().m1id() > 49) {
                isProto3 = isProto32;
            } else {
                isProto3 = isProto32;
    ...
    private static void storeFieldData(FieldInfo fi, int[] buffer, int bufferIndex, Object[] objects) {
        ...
        if (oneof != null) {
            typeId = fi.getType().m1id() + ONEOF_TYPE_OFFSET;
    ...
    private int getSerializedSizeProto2(T message) {
        ...
        while (i < this.buffer.length) {
            ...
            int presenceMask = 0;
            if (fieldType > 17) {
                if (this.useCachedSizeField && fieldType >= FieldType.DOUBLE_LIST_PACKED.m1id() && fieldType <= FieldType.SINT64_LIST_PACKED.m1id()) {
    ...
    private int getSerializedSizeProto3(T message) {
        ...
        for (int i = 0; i < this.buffer.length; i += 3) {
            ...
            int number = numberAt(i);
            long offset = offset(typeAndOffset);
            if (fieldType >= FieldType.DOUBLE_LIST_PACKED.m1id() && fieldType <= FieldType.SINT64_LIST_PACKED.m1id()) {
     ...
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Removed duplicated region for block: B:193:0x06fa A[Catch: all -> 0x0764, TRY_LEAVE, TryCatch #0 {all -> 0x0764, blocks: (B:174:0x06b6, B:191:0x06f4, B:193:0x06fa, B:206:0x0730, B:207:0x0735, B:71:0x0136, B:72:0x014a, B:73:0x0160, B:74:0x0176, B:75:0x018c, B:76:0x01a2, B:78:0x01ac, B:81:0x01b3, B:82:0x01bd, B:83:0x01ce, B:84:0x01e4, B:85:0x01f5, B:86:0x020a, B:87:0x0213, B:88:0x0229, B:89:0x023f, B:90:0x0255, B:91:0x026b, B:92:0x0281, B:93:0x0297, B:94:0x02ad), top: B:230:0x06b6 }] */
    ...
    */
                                    ...
                                    try {
                                        ...
                                        if (!unknownFieldSchema3.shouldDiscardUnknownFields(reader3)) {
                                            if (unknownFields2 == null) {
                                                UB unknownFields3 = unknownFieldSchema3.getBuilderFromMessage(t);
                                                unknownFields2 = unknownFields3;
                                            }
                                            ...
                                            if (!mergeOneFieldFrom) {
                                                ...
                                                for (int i2 = this.checkInitializedCount; i2 < this.repeatedFieldOffsetStart; i2++) {
                                                    r11 = filterMapUnknownEnumValues(message, this.intArray[i2], r11, unknownFieldSchema, message);
                                                }
                                                if (r11 != null) {
                                            ...
                                            while (i3 < this.repeatedFieldOffsetStart) {
                                                unknownFields2 = (UB) filterMapUnknownEnumValues(message, this.intArray[i3], unknownFields2, unknownFieldSchema, message);
                                                i3++;
                                                e222 = e222;
                                            }
                                            UB unknownFields4 = unknownFields2;
                                            if (unknownFields4 != null) {
                                                unknownFieldSchema3.setBuilderToMessage(t, unknownFields4);
                                                return;
                                            }
                                            return;
                                        } else {
                                        ...
                                        try {
                                            if (!unknownFieldSchema6.mergeOneFieldFrom(unknownFields2, reader3)) {
                                                ...
                                                if (unknownFields5 != null) {
                                                    unknownFieldSchema6.setBuilderToMessage(t, unknownFields5);
                                                    return;
                                                }
                                                return;
                                            }
    ...
    /* loaded from: classes.dex */
    public static /* synthetic */ class C00241 {
    ...
    private int decodeMapEntryValue(byte[] data, int position, int limit, WireFormat.FieldType fieldType, Class<?> messageType, ArrayDecoders.Registers registers) throws IOException {
        switch (C00241.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
